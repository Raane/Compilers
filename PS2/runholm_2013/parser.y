...
/*
 * I didn't use these because I just started coding. Didn't contemplate too much about what they were for until I was done. 
 * In retrospect they would have made it easier to write the code, but I see no point in putting them in now.
 */
...
/*
 *  I am not sure if I am doing this right, but I am trying to follow the same
 *  kind of code pattern used in the recitation. I suspect this is what gives me
 *  seg. faults.
 */
